...
import 'package:wave_app/data/repositories/transfer_repository.dart' as transfer_repo;
import 'package:wave_app/data/repositories/transaction_repository.dart' as transaction_repo;
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // Fournisseurs de dépôt avec alias pour éviter le conflit de nom
        RepositoryProvider(
